MTF Epsilon-6 "Village Idiots" is a [[Mobile Task Force]] operating under the [[SCP Foundation]]. We specialize in investigation, containment, and clean-up inside rural and sub-urban environments. Although, we are flexible; we can be deployed into other environments if no more suitable candidates are available.
